...
namespace PaymentSystem.Domain
{
    ...
    public class StringTypeConverter<T> : TypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value) {
            ...
            if (stringValue == "<empty>") {
                if (typeof(T).GetConstructors(BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Public).Any(c => c.GetParameters().Length == 0))
    ...
    {
        public override bool CanConvertTo(ITypeDescriptorContext context, Type destinationType) {
            return destinationType == typeof(string) || destinationType == typeof(long) || destinationType == typeof(int);
        }

        public override bool CanConvertFrom(ITypeDescriptorContext context, Type sourceType) {
            return sourceType == typeof(string) || sourceType == typeof(long) || sourceType == typeof(int) || sourceType == typeof(decimal) || sourceType == typeof(double);
        }
    ...
    public class LongTypeConverter<T> : TypeConverter
    {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value) {
            if (value == null) return null;
            if (value is T) return value;
            if (value is string stringValue) return (T)Activator.CreateInstance(typeof(T), long.Parse(stringValue, CultureInfo.InvariantCulture));
    ...
    public class DecimalTypeConverter<T> : TypeConverter
    {
        ...
        public override bool CanConvertFrom(ITypeDescriptorContext context, Type sourceType) {
            return sourceType == typeof(string) || sourceType == typeof(decimal) ||  sourceType == typeof(int) || sourceType == typeof(long);
        }

        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value) {
            if (value == null) return null;
            if (value is T) return value;
            if (value is string stringValue) return (T)Activator.CreateInstance(typeof(T), decimal.Parse(stringValue, CultureInfo.InvariantCulture));
    ...
    public class DoubleTypeConverter<T> : TypeConverter
    {
        ...
        public override bool CanConvertFrom(ITypeDescriptorContext context, Type sourceType) {
            return sourceType == typeof(string) || sourceType == typeof(double) || sourceType == typeof(int) || sourceType == typeof(long) || sourceType == typeof(decimal);
        }

        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value) {
            if (value == null) return null;
            if (value is T) return value;
            if (value is string stringValue) return (T)Activator.CreateInstance(typeof(T), double.Parse(stringValue, CultureInfo.InvariantCulture));
